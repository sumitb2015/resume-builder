...
const HeroSection: React.FC<Props> = ({ onStart }) => (
  <section id="hero" style={{ position: 'relative', padding: '110px 48px 90px', maxWidth: '960px', margin: '0 auto', textAlign: 'center' }}>
    ...
    {/* Headline */}
    <h1 style={{ fontSize: 'clamp(48px, 7vw, 80px)', fontWeight: 800, letterSpacing: '-0.04em', lineHeight: 1.0, color: 'white', marginBottom: '24px' }}>
      Resumes that
      <br />
    ...
    {/* Subheading */}
    <p style={{ fontSize: '19px', fontWeight: 400, color: 'rgba(255,255,255,0.5)', lineHeight: 1.65, maxWidth: '580px', margin: '0 auto 44px' }}>
    ...
    <div style={{ marginTop: '60px', display: 'flex', justifyContent: 'center', alignItems: 'center', gap: '16px', flexWrap: 'wrap' }}>
      ...
      <span style={{ fontSize: '13.5px', color: 'rgba(255,255,255,0.4)', fontWeight: 500 }}>
        Loved by <strong style={{ color: 'rgba(255,255,255,0.65)' }}>50,000+</strong> job seekers
      </span>
    </div>
  </section>
);
