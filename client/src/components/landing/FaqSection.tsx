...
const FaqSection: React.FC = () => {
  ...
  const FAQS: FaqItem[] = [
    ...
    },
    {
      ...
      answer: `There are ${templates.length}+ professional templates ranging from minimal single-column layouts to two-column executive designs. Basic plan users get access to 3 templates; Pro and Ultimate unlock all ${templates.length}+. Every template is A4-sized and fully ATS-compatible.`,
    },
    {
      category: 'Features',
