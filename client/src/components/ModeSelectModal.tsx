...
export default function ModeSelectModal({ onSelect, onBack }: Props) {
      ...
      <header style={{
        ...
        <button
          ...
          style={{
            ...
            color: 'var(--color-ui-text-muted)', fontSize: '13px', fontWeight: 500,
      ...
      <div style={{
        ...
        {step === 'loading' && (
          <div style={{ textAlign: 'center' }}>
            ...
            <p style={{ fontSize: '13px', color: 'var(--color-ui-text-muted)', marginTop: '8px' }}>
          ...
          <>
            ...
            <div style={{ display: 'flex', gap: '20px', flexWrap: 'wrap', justifyContent: 'center', maxWidth: '900px', width: '100%' }}>
              ...
              <ModeCard
                ...
                onClick={() => { setError(''); setFile(null); setStep('enhance'); }}
              />
              ...
              <ModeCard
                ...
                onClick={() => { setError(''); setLinkedinText(''); setStep('linkedin'); }}
              />
            </div>
          </>
        )}
          ...
          <div style={{ width: '100%', maxWidth: '520px' }}>
            <button
              ...
              style={{
                display: 'flex', alignItems: 'center', gap: '6px',
                background: 'transparent', border: 'none', cursor: 'pointer',
                color: 'var(--color-ui-text-muted)', fontSize: '13px',
                marginBottom: '32px', padding: 0,
              }}
            >
              <ArrowLeft size={14} /> Back
            </button>
            <h2 style={{ fontSize: '22px', fontWeight: 800, color: 'var(--color-ui-text)', marginBottom: '8px', letterSpacing: '-0.02em' }}>
              Upload your resume
            </h2>
            <p style={{ fontSize: '13px', color: 'var(--color-ui-text-muted)', marginBottom: '28px' }}>
              AI will read your resume and pre-fill all fields, plus suggest improvements.
            </p>
            ...
            <div
              ...
              onDrop={handleDrop}
              style={{
                border: `2px dashed ${dragOver ? '#F59E0B' : file ? '#4ADE80' : 'var(--color-ui-border)'}`,
                borderRadius: '14px',
                padding: '40px 24px',
                textAlign: 'center',
                cursor: 'pointer',
                background: dragOver ? 'rgba(245,158,11,0.04)' : file ? 'rgba(74,222,128,0.04)' : 'var(--color-ui-surface)',
                transition: 'all 0.2s',
                marginBottom: '16px',
              }}
            >
              ...
              {file ? (
                <div>
                  ...
                  <p style={{ fontSize: '12px', color: 'var(--color-ui-text-muted)', marginTop: '4px' }}>
        ...
        {step === 'linkedin' && (
          <div style={{ width: '100%', maxWidth: '560px' }}>
            ...
            <p style={{ fontSize: '13px', color: 'var(--color-ui-text-muted)', marginBottom: '20px' }}>
              LinkedIn blocks automated scraping, so copy your profile text manually and paste it below.
            </p>

            {/* How-to steps */}
            <div style={{
              padding: '14px 16px', background: 'rgba(56,189,248,0.06)',
              border: '1px solid rgba(56,189,248,0.2)', borderRadius: '10px', marginBottom: '20px',
            }}>
              ...
              <ol style={{ margin: 0, paddingLeft: '18px', display: 'flex', flexDirection: 'column', gap: '4px' }}>
                {[
                  ...
                  'Paste below with Ctrl+V',
                ].map((step, i) => (
                  <li key={i} style={{ fontSize: '12px', color: 'var(--color-ui-text-muted)', lineHeight: 1.6 }}>{step}</li>
                ))}
              </ol>
            </div>
            ...
            <div style={{ marginBottom: '16px' }}>
              ...
              <textarea
                ...
                value={linkedinText}
                onChange={e => { setLinkedinText(e.target.value); setError(''); }}
...
function ModeCard({ icon, iconColor, iconBg, title, description, badgeText, badgeColor, badgeBg, onClick }: ModeCardProps) {
  ...
  return (
    <button
      ...
      style={{
        ...
        border: `1.5px solid ${hovered ? iconColor : 'var(--color-ui-border)'}`,
        borderRadius: '16px',
        cursor: 'pointer',
        textAlign: 'left',
        transition: 'all 0.2s',
    ...
    >
      <div style={{
        ...
        color: iconColor, marginBottom: '18px',
      }}>
        {icon}
      </div>
      ...
      <div style={{
        ...
        background: badgeBg, marginBottom: '12px',
      }}>
        <span style={{ fontSize: '11px', fontWeight: 700, color: badgeColor, letterSpacing: '0.04em' }}>
          {badgeText}
        </span>
      </div>

      <h3 style={{ fontSize: '16px', fontWeight: 700, color: 'var(--color-ui-text)', marginBottom: '8px', letterSpacing: '-0.01em' }}>
        {title}
      </h3>
